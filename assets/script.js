document.addEventListener("DOMContentLoaded", () => {
  ...
  const nextStreamDate = "3/25/2026";
  ...
  const indexAnnouncements = [
    ...
    "All players planning to travel to San Diego or Dallas <strong>MUST</strong> fill out a driver's agreement (https://sportclubs.tamu.edu/driverrecord/create)!"
  ];
